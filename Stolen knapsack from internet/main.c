...
int n = 7; /* The number of objects */
int c[10] = {2, 3, 5, 7, 1, 4,1}; /* c[i] is the *COST* of the ith object; i.e. what
                YOU PAY to take the object */
int v[10] = {10, 5, 15, 7, 6,18,3}; /* v[i] is the *VALUE* of the ith object; i.e.
